...
{
	float4 Pos : POSITION0;
	float3 P_Tex0_ZFade : TEXCOORD0; // .xy = Tex0; .z = ZFade;
	float3 P_Tex1_Fog : TEXCOORD1; // .xy = Tex0; .z = ZFade;
	float4 LightTex : TEXCOORD2;
};

VS2PS Editor_Road_Detail_VS(APP2VS Input)
{
...
float4 Editor_Road_Detail_PS(VS2PS Input) : COLOR
{
...
technique defaultTechnique
{
	pass P0
	{
		VertexShader = compile vs_3_0 Editor_Road_Detail_VS();
		PixelShader = compile ps_3_0 Editor_Road_Detail_PS();

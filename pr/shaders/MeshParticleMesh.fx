...
/*
	Description: Renders 3D particle debris from explosions. It is instanced to render up to 26 particles in a single draw call.
...
RGraphics_PS2FB_NoDepth PS_Diffuse(VS2PS Input)
{
...
RGraphics_PS2FB_NoDepth PS_Additive(VS2PS Input)
{
	RGraphics_PS2FB_NoDepth Output = (RGraphics_PS2FB_NoDepth)0.0;

...
/*
	Description: Renders lighting for static mesh (buildings, static props) and calculates tangent-space lighting.
*/
...
VS2PS VS_StaticMesh(APP2VS Input)
{
	...
	#endif
	#if _SHADOW_ && _LIGHTMAP_
		Output.ShadowTex = Ra_GetMeshShadowProjection(ObjectPos);
	#endif
